...
_nginx_config_extras += --with-openssl=openssl-$(OPENSSL_VERSION)
dependencies/openssl:
	...
	@cp -fr dependencies/openssl/$(OPENSSL_VERSION)/openssl-$(OPENSSL_VERSION)/* $(BUILDROOT)openssl-$(OPENSSL_VERSION);
